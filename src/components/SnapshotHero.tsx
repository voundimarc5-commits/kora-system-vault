...
const SnapshotHero = () => {
  ...
  return (
    <section id="snapshot" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-0 md:pt-4">
      ...
      <div className="max-w-4xl mx-auto px-6 py-2 md:py-8 relative z-10 w-full">
